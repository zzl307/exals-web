		...
		<div class="col-md-12">
			...
			<div class="widget box">
				...
				<div class="widget-content no-padding">
					<form class="form-horizontal row-border" action="{{ route('nbx.index') }}" method="get">
							...
							<tbody>
								@foreach($logs as $vo)
									<tr>
										...
										<td>
											<a href="{{ route('nbx.show', ['id' => $vo->id, 'date' => $data['date']]) }}" class="btn btn-xs bs-tooltip" title="详情"><i class="icon-eye-open"></i></a>
										</td>
									</tr>
								@endforeach
							</tbody>
