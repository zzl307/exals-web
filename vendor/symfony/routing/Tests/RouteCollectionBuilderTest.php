...
class RouteCollectionBuilderTest extends TestCase
{
    ...
    public function testFlushSetsPrefixedWithMultipleLevels()
    {
        ...
        $adminRoutes->add('/users', 'AdminController::userAction', 'admin_user');
        ...
        $this->assertEquals('/admin/users', $collection->get('admin_user')->getPath(), 'Routes after mounting have the prefix');
